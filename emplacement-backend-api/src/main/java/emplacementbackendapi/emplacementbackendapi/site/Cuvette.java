...
public class Cuvette {
    ...
    public String getHomeInterShipDetails(String page){
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://api.cuvette.tech/api/v1/student/internship-post/active?pageNumber="+ page + "&sortByDate=true&stipendRange=[5000]"))
    ...
    public String getInternshipTitles(){
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://api.cuvette.tech/api/v1/admin/internship-title?filter=[object%20Object]&pageSize=&pageNumber="))
                .method("GET", HttpRequest.BodyPublishers.noBody())
                .setHeader("authorization",TOKEN)
                .setHeader("user-agent",USER_AGENT)
                .build();
    ...
    public String getResultsByRole(String role_id,String page){
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://api.cuvette.tech/api/v1/student/internship-post/active?pageNumber="+page+"&refInternshipTitle=[%22" + role_id + "%22]&sortByDate=true&stipendRange=[5000]"))
                .method("GET", HttpRequest.BodyPublishers.noBody())
                .setHeader("authorization",TOKEN)
                .setHeader("user-agent",USER_AGENT)
                .build();
